...
struct ItunesJson: Codable, Identifiable, Equatable {
    ...
    static func getTestItunesJson() -> ItunesJson {
        return ItunesJson(id: 1514, artistName: "Error", collectionNameString: "Collapse", collectionViewUrl: "https://music.apple.com/us/album/jack-johnson-and-friends-sing-a-longs-and/1469577723?uo=4", artworkUrl100: "https://is3-ssl.mzstatic.com/image/thumb/Music115/v4/08/11/d2/0811d2b3-b4d5-dc22-1107-3625511844b5/00602537869770.rgb.jpg/100x100bb.jpg", releaseDate: "1970-01-02T08:00:00Z", wrapperType: nil, collectionType: nil, artistId: nil, collectionId: nil, amgArtistId: nil, collectionCensoredName: "Error", artistViewUrl: nil, artworkUrl60: nil, collectionPrice: nil, collectionExplicitness: nil, trackCount: nil, copyright: nil, country: nil, currency: nil, primaryGenreName: nil)
    }
    
    static let shared = ItunesJson(id: 1514, artistName: "Error", collectionNameString: "Collapse", collectionViewUrl: "https://music.apple.com/us/album/jack-johnson-and-friends-sing-a-longs-and/1469577723?uo=4", artworkUrl100: "https://is3-ssl.mzstatic.com/image/thumb/Music115/v4/08/11/d2/0811d2b3-b4d5-dc22-1107-3625511844b5/00602537869770.rgb.jpg/100x100bb.jpg", releaseDate: "1971-01-02T08:00:00Z", wrapperType: nil, collectionType: nil, artistId: nil, collectionId: nil, amgArtistId: nil, collectionCensoredName: "Error", artistViewUrl: nil, artworkUrl60: nil, collectionPrice: nil, collectionExplicitness: nil, trackCount: nil, copyright: nil, country: nil, currency: nil, primaryGenreName: nil)
}
